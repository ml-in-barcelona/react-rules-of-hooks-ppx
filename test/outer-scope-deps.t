...
External module values (like Js.log) in deps are unnecessary
  $ ../src/standalone.exe input.ml 2>&1
  [@@@ocaml.ppwarning
    "exhaustive-deps: React.useEffect1 has an unnecessary dependency: 'Js.log'. Outer scope values like 'Js.log' aren't valid dependencies because mutating them doesn't re-render the component.\nTo suppress this warning, add [@disable_exhaustive_deps] to the expression"]
  let make () =
